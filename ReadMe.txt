...
2. The second path which is localhost:{path generated}/cities?message="Insert message here" which requests the AI model to look up on the current weather based on the city provided in the message 
